...
\begin{enumerate}
    ...
    \item \textbf{Registro de Dados:} Anote a deflexão (deslocamento $\Delta x$) medida pelo seu sensor (ex: laser ou LVDT) e a tensão aplicada (script em Python automatizado).
